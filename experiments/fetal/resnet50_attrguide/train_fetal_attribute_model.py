...
# -*- coding: utf-8 -*-
"""
Train attribute-guided fetal ultrasound image classification model (TransZero-style)
...
def build_class_mapping(class_keys: List[str], attr_processor: AttributeProcessor, filter_unmatched: bool = True) -> Dict[str, str]:
    ...
    .csv `name`
     utils/attribute_processor.py  attr_dict  `name`  key
        ...
        class_keys = ['crl', 'nt', ...]
        attr_processor.attr_dict.keys() = ['crl', 'nt', ...]
...
def parse_args():
    parser = argparse.ArgumentParser(description="Train Attribute-Guided Fetal Ultrasound Image Classification Model")
    parser.add_argument("--data_root", type=str, default="data/fetal",
                        help="Dataset root containing train/ and test/ folders")
    parser.add_argument("--attr_csv", type=str, default="examples/attributes_fetal.csv",
                        help="CSV file with the class-attribute table")
    parser.add_argument("--precomputed_attr_emb", type=str, default="data/attribute_embeddings_fetal.pt",
    ...
    parser.add_argument("--resnet_path", type=str, default="pretrained/resnet50-11ad3fa6.pth",
    ...
    parser.add_argument("--wandb_project", type=str, default="fetal-ultrasound-classification", help="Wandb project name")
...
def main():
    ...
    if args.resnet_path is None or "resnet50" not in args.resnet_path:
    ...
    if args.use_wandb:
        ...
        wandb_tags = [sanitize_string_for_wandb(tag) for tag in ["attribute-guided", "fetal-ultrasound", f"lambda_reg_{args.lambda_reg}"]]
    ...
    print("\n==========================================")
    print("Train Attribute-Guided Fetal Ultrasound Image Classification Model (FETALPRIVATE)")
    ...
    backbone_feat_dim = 2048  # ResNet50
    ...
    if args.use_wandb and wandb.run:
        try:
            ...
            if job_id:
                ...
                output_files = [f"fetal_attr_{job_id}.out", f"fetal_attr_{job_id}.err"]
