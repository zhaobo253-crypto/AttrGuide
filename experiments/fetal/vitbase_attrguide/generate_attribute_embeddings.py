...
def parse_args():
    ...
    parser.add_argument("--clip_download_root", type=str, default=None,
                       help="Custom directory for CLIP model download (default: ~/.cache/clip). "
                            "Use this to avoid disk quota issues, e.g., pretrained/clip")
        ...
        if not os.path.exists(args.clip_model_path):
            ...
            try:
                ...
                try:
                    ...
                    print(f" CLIP model loaded directly from file path successfully!")
                    ...
                    cache_dirs.append("pretrained/clip")
                            ...
                            for cached_model_path in cached_model_patterns:
                                if os.path.exists(cached_model_path):
                                    ...
                                    try:
                                        ...
                                        attr_processor.clip_model = model
                                        attr_processor.device = device
                                        print(f" CLIP model loaded: architecture from cache, weights from {args.clip_model_path}")
                                        model_loaded = True
                                        break
